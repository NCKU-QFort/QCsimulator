# Quantum Circuit (QC) Simulator 量子電路模擬器
...
Local build and start the development server:

```bash
npm run dev
```

This will start a local site at http://localhost:5173 in your computer.
